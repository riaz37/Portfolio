...
const StickyIcons: React.FC = () => {
  ...
  const socialLinks: IconLinkProps[] = [
    { icon: FaGithub, href: 'https://github.com/riaz37' },
    { icon: FaLinkedin, href: 'https://www.linkedin.com/in/riaz37' },
    { icon: FaFacebook, href: 'https://www.facebook.com/rafi302001' },
